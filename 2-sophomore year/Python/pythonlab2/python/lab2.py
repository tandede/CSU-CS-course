...
datafile = 'C:/Users/Dell/Desktop/python/air_data.csv'  # 航空原始数据路径
...
airline.to_csv(cleanedfile)  # 保存处理后的数据
...
k = 5  # 确定聚类中心数
# 构建模型，随机种子设为666
kmeans_model = KMeans(n_clusters=k, random_state=666)
...
with open('data_cleaned.csv','r',encoding='utf-8')as fp:
