...
class TranslationApp:
    ...
    def create_widgets(self):
        ...
        self.text_entry = tk.Entry(self.root, textvariable=self.text_var, width=40)
        self.text_entry.grid(row=0, column=0, padx=10, pady=10)

        self.translate_button = tk.Button(self.root, text="翻译", command=self.translate_and_speak)
        self.translate_button.grid(row=0, column=1, padx=10, pady=10)

        # 图片按钮 - 输入框旁边
        self.image_path_input = "img/laba.png"  # 替换为你的图片路径
        ...
        self.laba_button_input = tk.Button(self.root, image=self.laba_img_input, text="输入", compound=tk.LEFT,command=self.speak_input_text)
        self.laba_button_input.grid(row=0, column=2, padx=5, pady=10)

        self.from_lang_label = tk.Label(self.root, text="源语言:")
        self.from_lang_label.grid(row=1, column=0, padx=10, pady=10)
        ...
        self.to_lang_label.grid(row=2, column=0, padx=10, pady=10)
        ...
        self.translation_text.grid(row=3, column=1, padx=10, pady=10)

        # 图片按钮 - 输出框旁边
        self.image_path_output = "img/laba.png"  # 替换为你的图片路径
        ...
        self.laba_button_output = tk.Button(self.root, image=self.laba_img_output, text="输出", compound=tk.LEFT,command=self.speak_output_text)
